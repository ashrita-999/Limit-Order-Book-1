...
def ls_entropy_fit_with_edge_residuals(beta_grid, phi_grid, M_totals, G_totals, gauge_fix=True):
    ...
    # Uncentred TSS for LS entropy edge fit
...
def ols_entropy_agreement(S_num, S_theory, name_num="S_LOB_mean", name_theory="S_CD"):
...
if __name__ == "__main__":
    ...
    # =====================================================
    # NEW: LS diagnostics for the mean beta/phi field
    # This gives RSS/TSS for S_mean / mean reconstructed entropy.
    # =====================================================
